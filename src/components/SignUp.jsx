        ...
        >
          {loading ? (
            ...
            >
                ...
                <View style={tw`flex flex-col items-center justify-center rounded-full p-3`}>
                <Image
                  style={[tw`flex flex-col items-center justify-center h-60 w-60  rounded-full`, { resizeMode: "cover" }]}
                  source={{
